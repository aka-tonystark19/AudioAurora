...
`timescale 1 ps / 1 ps
module audioUart_mm_interconnect_0 (
	...
	wire  [14:0] rs232_s1_agent_m0_address;                                                          // rs232_s1_agent:m0_address -> rs232_s1_translator:uav_address
	...
	wire  [91:0] rs232_s1_agent_rf_source_data;                                                      // rs232_s1_agent:rf_source_data -> rs232_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] rs232_s1_agent_rsp_fifo_out_data;                                                   // rs232_s1_agent_rsp_fifo:out_data -> rs232_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> rs232_s1_agent:cp_valid
	wire  [90:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> rs232_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // rs232_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> rs232_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> rs232_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> rs232_s1_agent:cp_endofpacket
	...
	wire         rs232_s1_agent_rp_valid;                                                            // rs232_s1_agent:rp_valid -> router_006:sink_valid
	wire  [90:0] rs232_s1_agent_rp_data;                                                             // rs232_s1_agent:rp_data -> router_006:sink_data
	wire         rs232_s1_agent_rp_ready;                                                            // router_006:sink_ready -> rs232_s1_agent:rp_ready
	wire         rs232_s1_agent_rp_startofpacket;                                                    // rs232_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         rs232_s1_agent_rp_endofpacket;                                                      // rs232_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         rs232_s1_agent_rdata_fifo_src_valid;                                                // rs232_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] rs232_s1_agent_rdata_fifo_src_data;                                                 // rs232_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         rs232_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_004:in_0_ready -> rs232_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> rs232_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> rs232_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // rs232_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> rs232_s1_agent:rdata_fifo_sink_error
	...
	audioUart_mm_interconnect_0_router router (
	...
	audioUart_mm_interconnect_0_router_001 router_001 (
	...
	audioUart_mm_interconnect_0_router_002 router_002 (
	...
	audioUart_mm_interconnect_0_router_003 router_003 (
	...
	audioUart_mm_interconnect_0_router_003 router_004 (
	...
	audioUart_mm_interconnect_0_router_002 router_005 (
	...
	audioUart_mm_interconnect_0_router_002 router_006 (
	...
	audioUart_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audioUart_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	audioUart_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rs232_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (rs232_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (rs232_s1_agent_rdata_fifo_src_ready),           //         .ready
