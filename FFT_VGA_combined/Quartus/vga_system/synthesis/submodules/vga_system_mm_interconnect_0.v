...
module vga_system_mm_interconnect_0 (
	...
	wire   [27:0] vga_integrate_0_avalon_slave_0_agent_m0_address;                                    // vga_integrate_0_avalon_slave_0_agent:m0_address -> vga_integrate_0_avalon_slave_0_translator:uav_address
	...
	wire  [104:0] vga_integrate_0_avalon_slave_0_agent_rf_source_data;                                // vga_integrate_0_avalon_slave_0_agent:rf_source_data -> vga_integrate_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [104:0] vga_integrate_0_avalon_slave_0_agent_rsp_fifo_out_data;                             // vga_integrate_0_avalon_slave_0_agent_rsp_fifo:out_data -> vga_integrate_0_avalon_slave_0_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> vga_integrate_0_avalon_slave_0_agent:cp_valid
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> vga_integrate_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // vga_integrate_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> vga_integrate_0_avalon_slave_0_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> vga_integrate_0_avalon_slave_0_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> vga_integrate_0_avalon_slave_0_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> timer_0_s1_agent:cp_data
	...
	wire          vga_integrate_0_avalon_slave_0_agent_rp_valid;                                      // vga_integrate_0_avalon_slave_0_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] vga_integrate_0_avalon_slave_0_agent_rp_data;                                       // vga_integrate_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	wire          vga_integrate_0_avalon_slave_0_agent_rp_ready;                                      // router_003:sink_ready -> vga_integrate_0_avalon_slave_0_agent:rp_ready
	wire          vga_integrate_0_avalon_slave_0_agent_rp_startofpacket;                              // vga_integrate_0_avalon_slave_0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          vga_integrate_0_avalon_slave_0_agent_rp_endofpacket;                                // vga_integrate_0_avalon_slave_0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [103:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire    [5:0] router_005_src_channel;                                                             // router_005:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire          vga_integrate_0_avalon_slave_0_agent_rdata_fifo_src_valid;                          // vga_integrate_0_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] vga_integrate_0_avalon_slave_0_agent_rdata_fifo_src_data;                           // vga_integrate_0_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          vga_integrate_0_avalon_slave_0_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_001:in_0_ready -> vga_integrate_0_avalon_slave_0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> vga_integrate_0_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> vga_integrate_0_avalon_slave_0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // vga_integrate_0_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> vga_integrate_0_avalon_slave_0_agent:rdata_fifo_sink_error
	...
	vga_system_mm_interconnect_0_router_002 router_004 (
	...
	vga_system_mm_interconnect_0_router_002 router_006 (
	...
	vga_system_mm_interconnect_0_router_003 router_007 (
	...
	vga_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                 //       clk.clk
		.reset               (vga_integrate_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (pll_0_outclk0_clk),                                 //       clk.clk
		.reset               (vga_integrate_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                 //       clk.clk
		.reset              (vga_integrate_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
	...
	vga_system_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                                 //       clk.clk
		.reset              (vga_integrate_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	vga_system_mm_interconnect_0_avalon_st_adapter_003 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
