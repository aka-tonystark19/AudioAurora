...
# Memory: ram_data
MEM_0 := sort_hw_ram_data
$(MEM_0)_NAME := ram_data
...
$(MEM_0)_START := 0x00006000
$(MEM_0)_END := 0x00007fff
$(MEM_0)_SPAN := 0x00002000
$(MEM_0)_HIERARCHICAL_PATH := ram_data
$(MEM_0)_WIDTH := 32
...
.PHONY: ram_data
ram_data: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ram_instr
MEM_1 := sort_hw_ram_instr
$(MEM_1)_NAME := ram_instr
...
$(MEM_1)_HIERARCHICAL_PATH := ram_instr
$(MEM_1)_WIDTH := 32
...
.PHONY: ram_instr
ram_instr: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
