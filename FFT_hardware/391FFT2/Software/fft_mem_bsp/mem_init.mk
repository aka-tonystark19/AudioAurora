...
$(MEM_0)_START := 0x00007000
$(MEM_0)_END := 0x00007fff
$(MEM_0)_SPAN := 0x00001000
$(MEM_0)_HIERARCHICAL_PATH := ram_1
$(MEM_0)_WIDTH := 32
...
.PHONY: ram_1
ram_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_START := 0x00006000
$(MEM_1)_END := 0x00006fff
$(MEM_1)_SPAN := 0x00001000
$(MEM_1)_HIERARCHICAL_PATH := ram_2
$(MEM_1)_WIDTH := 32
...
.PHONY: ram_2
ram_2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: ram_instr
MEM_2 := fft_acc_ram_instr
$(MEM_2)_NAME := ram_instr
...
$(MEM_2)_START := 0x00008000
$(MEM_2)_END := 0x0000ffff
$(MEM_2)_SPAN := 0x00008000
$(MEM_2)_HIERARCHICAL_PATH := ram_instr
$(MEM_2)_WIDTH := 32
...
.PHONY: ram_instr
ram_instr: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
